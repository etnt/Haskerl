...
d1 = EXtuple [(EXvar "x"), (EXatom "true"), (EXvar "y")]
d2 = EXcons (EXvar "x") (EXvar "xs")
d3 = EXprimop "match_fail" [(EXtuple [(EXatom "function_clause"),(EXvar "_cor5"),(EXvar "_cor4")])]
d4 = EXcase ["_cor0","_cor2"] [(EClause [EPnil,EPnil] [(EXatom "true")] [EXnil])]
d5 = EFdef (EFname ("zip",2)) (EFun ["_cor0","_cor2"] d4)
d6 = EXlet ["_cor3"] [(EXapply (EXfname ("zip",2)) [(EXvar "xs"),(EXvar "ys")])] (EXcons (EXvar "_cor2") (EXvar "_cor3"))
